...
import com.junipersys.animations_transitions.transition.Fold;
import com.junipersys.animations_transitions.transition.Scale;
...
public class AlbumDetailActivity extends Activity {
    ...
    private Transition createTransition() {
        ...
        Transition title = new Fold();
        title.setDuration(150);
        title.addTarget(titlePanel);

        Transition track = new Fold();
        track.setDuration(150);
        track.addTarget(trackPanel);

        set.addTransition(track);
        set.addTransition(title);
